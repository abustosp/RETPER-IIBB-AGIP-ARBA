## BOT de Descarga Masiva de Retenciones y Percepciones de IIBB de ARBA y AGIP

Bot y Archivos de Configuración para la descarga masiva de Retenciones y Percepciones de IIBB de ARBA y AGIP.
